...
run('date')
run('java -Xmx8G -jar ${gatk_path} -T RealignerTargetCreator -nct 1 -nt 24 -R ref.fasta -I in.bam -o intervals.list ')


run('echo STARTING IndelRealigner')
run('date')
run('java -Xmx4G -jar ${gatk_path} -T IndelRealigner -nct 1 -nt 1 -R ref.fasta -I in.bam -targetIntervals intervals.list -o ${out_bam_fn}')
