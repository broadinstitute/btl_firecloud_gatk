...
if __name__ == "__main__":
    ...
    inputs_dict = {
        'gatk_bqsr.in_bam':'gs://broad-cil-devel-bucket/input_data/Candida_Auris.tcir.bam',
        'gatk_bqsr.in_bam_index':'gs://broad-cil-devel-bucket/input_data/Candida_Auris.tcir.bam.bai',
